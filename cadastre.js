	...
	*/
    ...
    L.CadUtils = {
        setOverlay: function(it, map) {
            ...
            var overlay = new L.ImageOverlay.CrossOrigin(imageUrl, map.getBounds(), {opacity: 0.5, full: attr.full, id: id, it: it, clickable: true})
				.on('load', function(ev) {
